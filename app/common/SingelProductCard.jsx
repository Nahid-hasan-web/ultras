    ...
    <>
      <div className='w-full lg:w-[400px] rounded-[6px] '>
       ...
       <div className='p-[10px] h-[512px] overflow-hidden relative  group border border-[#EAEAEA]'>
          ...
          <h2 className='text-[28px] font-semibold font-inter text-[#191919] mt-[34px] mb-[14px]'>Volunteer Half blue</h2>
          <div>
            <div className='flex items-center justify-between'>

          <h2 className='text-[34px] font-light font-inter text-[#6995B1]'>$ 35.00</h2>
          <p className='text-[14px] font-medium font-inter text-black'>Stock:30</p>
            </div>
          </div>
      </div>
    </>
